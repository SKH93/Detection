...
# pre-trained weight to tf weight
...
# strides, anchors, xyscale, num_class to load config file
...
# make image resize and gt_boxes 
...
# finish making from ground_truth box to score in single box
