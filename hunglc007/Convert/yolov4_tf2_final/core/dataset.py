...
class Dataset(object):
    ...
    def __next__(self):
        with tf.device("/cpu:0"):
            ...
            # from strides to grid --> shape initialize
...
# annotation each row to convert
...
#            bboxes = bboxes * np.array([width, height, width, height, 1]) ##if this code uses, index occurs error
...
# each grid / label, bboxes to make
