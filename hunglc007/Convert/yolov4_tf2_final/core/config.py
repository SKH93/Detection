...
__C.YOLO.CLASSES              = "./data/classes/lld.names"
...
__C.TRAIN.ANNOT_PATH          = "./data/dataset/annotations/416np_train.txt"
...
__C.TEST.ANNOT_PATH           = "./data/dataset/annotations/416np_test.txt"
